#!/usr/bin/env bash
# ==============================================================================
# TESTSUITE: Master 16: Enterprise Git-Flow & Release Suite
# ==============================================================================
...
echo -e "${BLUE}================================================================${NC}"
echo -e "${BLUE}🧪 TESTSUITE: Master 16: Enterprise Git-Flow & Release Suite${NC}"
echo -e "${BLUE}================================================================${NC}"
...
master_git_flow "$TEST_REPO"
RET=$?

if [ $RET -eq 0 ]; then
  echo -e "${GREEN}✓ Test 1: Funktion master_git_flow wurde erfolgreich ausgeführt.${NC}"
