#!/usr/bin/env bash
# ==============================================================================
# TESTSUITE: Git 11: Release-Tags & Semantische Versionierung
# ==============================================================================
...
echo -e "${BLUE}================================================================${NC}"
echo -e "${BLUE}🧪 TESTSUITE: Git 11: Release-Tags & Semantische Versionierung${NC}"
echo -e "${BLUE}================================================================${NC}"
...
manage_tags "$TEST_REPO"
RET=$?

if [ $RET -eq 0 ]; then
  echo -e "${GREEN}✓ Test 1: Funktion manage_tags wurde erfolgreich ausgeführt.${NC}"
