#!/usr/bin/env bash
# ==============================================================================
# TESTSUITE: Git 02: Staging Area, Commits & Historie
# ==============================================================================
...
echo -e "${BLUE}================================================================${NC}"
echo -e "${BLUE}🧪 TESTSUITE: Git 02: Staging Area, Commits & Historie${NC}"
echo -e "${BLUE}================================================================${NC}"
...
manage_commits "$TEST_REPO"
RET=$?

if [ $RET -eq 0 ]; then
  echo -e "${GREEN}✓ Test 1: Funktion manage_commits wurde erfolgreich ausgeführt.${NC}"
