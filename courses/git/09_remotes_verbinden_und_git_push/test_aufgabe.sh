#!/usr/bin/env bash
# ==============================================================================
# TESTSUITE: Git 09: Remote Repositories & Upstream Tracking
# ==============================================================================
...
echo -e "${BLUE}================================================================${NC}"
echo -e "${BLUE}🧪 TESTSUITE: Git 09: Remote Repositories & Upstream Tracking${NC}"
echo -e "${BLUE}================================================================${NC}"
...
setup_remote "$TEST_REPO"
RET=$?

if [ $RET -eq 0 ]; then
  echo -e "${GREEN}✓ Test 1: Funktion setup_remote wurde erfolgreich ausgeführt.${NC}"
