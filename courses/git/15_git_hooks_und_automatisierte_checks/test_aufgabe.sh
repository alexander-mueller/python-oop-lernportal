#!/usr/bin/env bash
# ==============================================================================
# TESTSUITE: Git 15: Pre-Commit Hooks & Automatisierung
# ==============================================================================
...
echo -e "${BLUE}================================================================${NC}"
echo -e "${BLUE}🧪 TESTSUITE: Git 15: Pre-Commit Hooks & Automatisierung${NC}"
echo -e "${BLUE}================================================================${NC}"
...
setup_pre_commit_hook "$TEST_REPO"
RET=$?

if [ $RET -eq 0 ]; then
  echo -e "${GREEN}✓ Test 1: Funktion setup_pre_commit_hook wurde erfolgreich ausgeführt.${NC}"
