#!/usr/bin/env bash
# ==============================================================================
# TESTSUITE: Git 01: Repository-Initialisierung & 3 Bereiche
# ==============================================================================
...
echo -e "${BLUE}================================================================${NC}"
echo -e "${BLUE}🧪 TESTSUITE: Git 01: Repository-Initialisierung & 3 Bereiche${NC}"
echo -e "${BLUE}================================================================${NC}"
...
if [ $RET -eq 0 ]; then
  echo -e "${GREEN}✓ Test 1: Funktion init_repository wurde erfolgreich ausgeführt.${NC}"
