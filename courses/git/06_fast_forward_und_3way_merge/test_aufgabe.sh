#!/usr/bin/env bash
# ==============================================================================
# TESTSUITE: Git 06: Fast-Forward & 3-Way-Merge Strategien
# ==============================================================================
...
echo -e "${BLUE}================================================================${NC}"
echo -e "${BLUE}🧪 TESTSUITE: Git 06: Fast-Forward & 3-Way-Merge Strategien${NC}"
echo -e "${BLUE}================================================================${NC}"
...
execute_merges "$TEST_REPO"
RET=$?

if [ $RET -eq 0 ]; then
  echo -e "${GREEN}✓ Test 1: Funktion execute_merges wurde erfolgreich ausgeführt.${NC}"
