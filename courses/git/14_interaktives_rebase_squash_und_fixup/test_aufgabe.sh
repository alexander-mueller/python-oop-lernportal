#!/usr/bin/env bash
# ==============================================================================
# TESTSUITE: Git 14: Interaktives Rebase (Squash & Fixup)
# ==============================================================================
...
echo -e "${BLUE}================================================================${NC}"
echo -e "${BLUE}🧪 TESTSUITE: Git 14: Interaktives Rebase (Squash & Fixup)${NC}"
echo -e "${BLUE}================================================================${NC}"
...
interactive_rebase "$TEST_REPO"
RET=$?

if [ $RET -eq 0 ]; then
  echo -e "${GREEN}✓ Test 1: Funktion interactive_rebase wurde erfolgreich ausgeführt.${NC}"
