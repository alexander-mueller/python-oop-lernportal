#!/usr/bin/env bash
# ==============================================================================
# TESTSUITE: Git 13: Lineare Historie mit Git Rebase
# ==============================================================================
...
echo -e "${BLUE}================================================================${NC}"
echo -e "${BLUE}🧪 TESTSUITE: Git 13: Lineare Historie mit Git Rebase${NC}"
echo -e "${BLUE}================================================================${NC}"
...
rebase_feature "$TEST_REPO"
RET=$?

if [ $RET -eq 0 ]; then
  echo -e "${GREEN}✓ Test 1: Funktion rebase_feature wurde erfolgreich ausgeführt.${NC}"
