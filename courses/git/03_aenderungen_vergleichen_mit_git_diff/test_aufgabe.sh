#!/usr/bin/env bash
# ==============================================================================
# TESTSUITE: Git 03: Diff-Analysen & Änderungen untersuchen
# ==============================================================================
...
echo -e "${BLUE}================================================================${NC}"
echo -e "${BLUE}🧪 TESTSUITE: Git 03: Diff-Analysen & Änderungen untersuchen${NC}"
echo -e "${BLUE}================================================================${NC}"
...
diff_inspection "$TEST_REPO"
RET=$?

if [ $RET -eq 0 ]; then
  echo -e "${GREEN}✓ Test 1: Funktion diff_inspection wurde erfolgreich ausgeführt.${NC}"
