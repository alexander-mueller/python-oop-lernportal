#!/usr/bin/env bash
# ==============================================================================
# TESTSUITE: Git 12: Selektive Commits mit Git Cherry-Pick
# ==============================================================================
...
echo -e "${BLUE}================================================================${NC}"
echo -e "${BLUE}🧪 TESTSUITE: Git 12: Selektive Commits mit Git Cherry-Pick${NC}"
echo -e "${BLUE}================================================================${NC}"
...
cherry_pick_commit "$TEST_REPO"
RET=$?

if [ $RET -eq 0 ]; then
  echo -e "${GREEN}✓ Test 1: Funktion cherry_pick_commit wurde erfolgreich ausgeführt.${NC}"
