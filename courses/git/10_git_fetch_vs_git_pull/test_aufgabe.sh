#!/usr/bin/env bash
# ==============================================================================
# TESTSUITE: Git 10: Git Fetch vs. Git Pull & Rebase
# ==============================================================================
...
echo -e "${BLUE}================================================================${NC}"
echo -e "${BLUE}🧪 TESTSUITE: Git 10: Git Fetch vs. Git Pull & Rebase${NC}"
echo -e "${BLUE}================================================================${NC}"
...
sync_upstream "$TEST_REPO"
RET=$?

if [ $RET -eq 0 ]; then
  echo -e "${GREEN}✓ Test 1: Funktion sync_upstream wurde erfolgreich ausgeführt.${NC}"
