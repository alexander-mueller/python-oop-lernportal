#!/usr/bin/env bash
# ==============================================================================
# TESTSUITE: Git 05: Branch-Management & HEAD-Pointer
# ==============================================================================
...
echo -e "${BLUE}================================================================${NC}"
echo -e "${BLUE}🧪 TESTSUITE: Git 05: Branch-Management & HEAD-Pointer${NC}"
echo -e "${BLUE}================================================================${NC}"
...
manage_branches "$TEST_REPO"
RET=$?

if [ $RET -eq 0 ]; then
  echo -e "${GREEN}✓ Test 1: Funktion manage_branches wurde erfolgreich ausgeführt.${NC}"
