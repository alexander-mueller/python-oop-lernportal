#!/usr/bin/env bash
# ==============================================================================
# TESTSUITE: Git 07: Merge-Konflikte analysieren & lösen
# ==============================================================================
...
echo -e "${BLUE}================================================================${NC}"
echo -e "${BLUE}🧪 TESTSUITE: Git 07: Merge-Konflikte analysieren & lösen${NC}"
echo -e "${BLUE}================================================================${NC}"
...
resolve_conflicts "$TEST_REPO"
RET=$?

if [ $RET -eq 0 ]; then
  echo -e "${GREEN}✓ Test 1: Funktion resolve_conflicts wurde erfolgreich ausgeführt.${NC}"
