# ==============================================================================
# PESTER TESTSUITE: AD 13: PowerShell ActiveDirectory-Modul Basics
# ==============================================================================
...
Describe "AD 13: PowerShell ActiveDirectory-Modul Basics" {
    # TEST: Funktion vorhanden
    It "Definiert die Funktion Get-ADUserReport" {
        ([bool](Get-Command Get-ADUserReport -ErrorAction SilentlyContinue)) | Should -Be $true
    }

    # TEST: Gibt Objekt mit Status zurück
    It "Führt die AD-Operation erfolgreich aus" {
        $res = Get-ADUserReport
    ...
    It "Bezieht sich auf das korrekte Modul" {
        $res = Get-ADUserReport
        $res.Module | Should -Be "13_powershell_activedirectory_modul_basics"
    }
}

Write-Host "✅ Alle Tests in AD 13: PowerShell ActiveDirectory-Modul Basics erfolgreich bestanden!" -ForegroundColor Green
